...
| Site | Probe | Cq (MHz) | η | Reference |
|------|-------|-----------|---|-----------|
| Tetrahedral Al (8a, inverted) | ²⁷Al | ~1.6 | ~0 | Millard et al. 1992 *Am. Min.* 77, 44 |
| Octahedral Al (16d, normal) | ²⁷Al | ~3.3–3.7 | ~0 | Millard et al. 1992; Kashii et al. 1999 |
| Octahedral Al near inverted neighbor | ²⁷Al | ~5–7 (broad) | 0–0.4 | Kashii et al. 1999 |

Note: Cq = 3·e·Q·V_zz / (2I(2I-1)·h) = 2 × nu_Q when η = 0 for spin-5/2.
The code outputs nu_Q = nu_z · (1 − η²/3)^(1/2) where nu_z = Cq/(2I(2I-1)) × ... check units.
...
- [ ] Confirm sites 24–55 are ordered O²⁻
...
- [ ] Distribution of η should span 0–1 (breaking of cubic symmetry by random neighbors)
...
- [ ] Compare mean point-charge nu_Q with published DFT-computed values:
  ...
  - Note: point-charge will likely overestimate Cq by 2–5× compared to DFT/experiment;
    a Sternheimer anti-shielding factor γ∞ ≈ −11 (for Al) can partly correct this.
